 ...
 */
public class ImageViewOptions implements Options<AppCompatImageView> {
    static {
    ...
    static final AppCompatImageView.ScaleType DEFAULT_SCALE_TYPE = AppCompatImageView.ScaleType.CENTER_CROP;
    ...
    */
    ...
    AppCompatImageView.ScaleType scaleType = DEFAULT_SCALE_TYPE;
    // Widget padding
    @Dimension(unit = PX)
    ...
    @Override
    public void completion(AppCompatImageView view) {
        // Set padding.
