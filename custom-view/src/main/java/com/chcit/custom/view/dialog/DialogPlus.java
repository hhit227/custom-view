...
public class DialogPlus {
  ...
  DialogPlus(DialogPlusBuilder builder) {
    ...
    AppCompatActivity activity = (AppCompatActivity) builder.getContext();
   ...
   */
  @Nullable public<T extends View> T findViewById(int resourceId) {
  ...
  private void initExpandAnimator(AppCompatActivity activity, int defaultHeight, int gravity) {
