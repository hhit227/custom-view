...
public class ImageInputEditText extends TextInputEditText {
    ...
    public ImageInputEditText(Context context) {
        this(context, (AttributeSet)null);
    }

    public ImageInputEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.editTextStyle);
    }

    public ImageInputEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.ic_delete_state = false;
        this.init(context, attrs);
    }
    public void setImageClick(OnClickListener onClickListener){
        imageClick = onClickListener;
    }
    private void init(Context context, AttributeSet attrs) {
        typedArray = context.obtainStyledAttributes(attrs, R.styleable.SuperInputEditText);
        int ic_left_clickResID = typedArray.getResourceId(R.styleable.SuperInputEditText_ic_left_click,R.drawable.svg_scan);
        ...
        int ic_left_unclickResID = typedArray.getResourceId(R.styleable.SuperInputEditText_ic_left_unclick, R.drawable.ic_san_gray);
