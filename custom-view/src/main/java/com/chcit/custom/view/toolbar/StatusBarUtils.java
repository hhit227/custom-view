...
public class StatusBarUtils {
     ...
     */
    public static void setBarColor(AppCompatActivity activity, int color) {
     ...
     * @param toolbar
     */
    public static void fixToolbar(Toolbar toolbar, AppCompatActivity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
     ...
     */
    public static void fixTitlebar(ViewGroup titlebar, AppCompatActivity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            int statusHeight = getStatusBarHeight(activity);
