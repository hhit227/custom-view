...
package com.chcit.custom.view.imagetext.image_engine;
...
import com.chcit.custom.view.imagetext.ImageEngine;
import com.chcit.custom.view.imagetext.utils.ThreadPool;
...
/**
 * 在调用{@link }后，
 * 如果没有通过{@link ImageEngine#(Engine)}配置过图片下载引擎，将使用这个简易版的
 * 图片下载引擎。
 * 建议开发者根据项目情况自行实现{@link Engine}，然后通过{@link ImageEngine#(Engine)}配置图片下载引擎。
 */
