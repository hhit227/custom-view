...
/**
 * Build CommonToolbar more easier.
 *
...
public class Builder {
    ...
    Builder(Context context) {
        if (context instanceof AppCompatActivity) {
            mContext = context;
            mContentParent = ((AppCompatActivity) mContext).findViewById(Window.ID_ANDROID_CONTENT);
        } else {
    ...
    /**
     * Instantiation CommonToolbar.
     */
    public CommonToolbar build() {
        final CommonToolbar toolbar = new CommonToolbar(mContext);
        completion(toolbar);
        return toolbar;
    }

    /**
     * Instantiation CommonToolbar, and then add it to suitable position.
     */
    public CommonToolbar apply() {
        final CommonToolbar toolbar = build();
        // Add to container.
     ...
     */
    private void completion(CommonToolbar toolbar) {
     ...
     */
    private void adjustLayout(CommonToolbar toolbar) {
        if (null != mContentParent && !(mContentParent instanceof LinearLayout)) {
            // Move origin content under the CommonToolbar.
